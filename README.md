...
Other cards: All other cards are worth their numerical value (an 3 is worth 3, a 5 is worth 5, etc.).  
...
Dealer's Choice: The dealer reveals the hole card and takes another card until the hand has a value of at least 17,(ore take cards until over player in value, ore are bursting) and then the game ends.
